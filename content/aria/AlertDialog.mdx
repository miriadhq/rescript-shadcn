...
For more information about the other components and their props, see the [React Aria documentation](https://react-spectrum.adobe.com/react-aria/components.html).
