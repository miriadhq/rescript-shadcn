...
| `open_`        | `bool`                    | Open state of the sidebar (controlled).      |
...
By default, `Sidebar.MenuButton` renders a React Aria button. Pass `href` to
render a React Aria link instead.

Use the `isActive` prop to mark a menu item as active.

```res showLineNumbers
<Sidebar.MenuButton href="#" isActive>
  {"Home"->React.string}
</Sidebar.MenuButton>
```
