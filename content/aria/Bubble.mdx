...
The `Bubble` component displays framed conversational content. Use it for chat text, short structured output, suggestions, and reactions. For full message rows with avatars or metadata, compose it inside [`Message`](/components/Message).
