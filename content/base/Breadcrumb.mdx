...
<ComponentPreview styleName="base-nova" name="BreadcrumbBasic" />

### Custom separator

Use a custom component as `children` for `<BreadcrumbSeparator />` to create a custom separator.

<ComponentPreview styleName="base-nova" name="BreadcrumbSeparator" />

### Dropdown

You can compose `<BreadcrumbItem />` with a `<DropdownMenu />` to create a dropdown in the breadcrumb.

<ComponentPreview styleName="base-nova" name="BreadcrumbDropdown" />
...
<ComponentPreview styleName="base-nova" name="BreadcrumbLink" />
