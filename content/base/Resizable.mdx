...
<ComponentPreview styleName="base-nova" name="ResizableVertical" />

### Handle

Use the `withHandle` prop on `ResizableHandle` to show a visible handle.

<ComponentPreview styleName="base-nova" name="ResizableHandle" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-nova" name="ResizableRtl" direction="rtl" />
