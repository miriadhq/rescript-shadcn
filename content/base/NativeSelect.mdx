...
<ComponentPreview styleName="base-nova" name="NativeSelectDemo" />
...
<ComponentPreview styleName="base-nova" name="NativeSelectGroups" />

### Disabled

Add the `disabled` prop to the `NativeSelect` component to disable the select.

<ComponentPreview styleName="base-nova" name="NativeSelectDisabled" />

### Invalid

Use `aria-invalid` to show validation errors and the `data-invalid` attribute to the `Field` component for styling.

<ComponentPreview styleName="base-nova" name="NativeSelectInvalid" />
