...
<ComponentPreview styleName="base-nova" name="TabsLine" />

### Vertical

Use `orientation="vertical"` for vertical tabs.

<ComponentPreview styleName="base-nova" name="TabsVertical" />

### Disabled

<ComponentPreview styleName="base-nova" name="TabsDisabled" />

### Icons

<ComponentPreview styleName="base-nova" name="TabsIcons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-nova" name="TabsRtl" direction="rtl" />
