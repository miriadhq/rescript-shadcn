...
<ComponentPreview styleName="base-nova" name="TooltipDemo" />
...
<ComponentPreview styleName="base-nova" name="TooltipSides" />

### With Keyboard Shortcut

<ComponentPreview styleName="base-nova" name="TooltipKeyboard" />

### Disabled Button

Show a tooltip on a disabled button by wrapping it with a span.

<ComponentPreview styleName="base-nova" name="TooltipDisabled" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-nova" name="TooltipRtl" direction="rtl" />
