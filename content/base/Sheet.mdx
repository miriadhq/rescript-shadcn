...
<ComponentPreview styleName="base-nova" name="SheetDemo" />
...
<ComponentPreview styleName="base-nova" name="SheetSide" />

### No Close Button

Use `showCloseButton={false}` on `SheetContent` to hide the close button.

<ComponentPreview styleName="base-nova" name="SheetNoCloseButton" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-nova" name="SheetRtl" direction="rtl" />
