...
<ComponentPreview styleName="base-nova" name="ProgressDemo" />
...
<ComponentPreview styleName="base-nova" name="ProgressLabel" />

### Controlled

A progress bar that can be controlled by a slider.

<ComponentPreview styleName="base-nova" name="ProgressControlled" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-nova" name="ProgressRtl" direction="rtl" />
