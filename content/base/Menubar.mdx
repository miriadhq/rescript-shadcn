...
<ComponentPreview styleName="base-nova" name="MenubarDemo" />
...
<ComponentPreview styleName="base-nova" name="MenubarCheckbox" />

### Radio

Use `MenubarRadioGroup` and `MenubarRadioItem` for single-select options.

<ComponentPreview styleName="base-nova" name="MenubarRadio" />

### Submenu

Use `MenubarSub`, `MenubarSubTrigger`, and `MenubarSubContent` for nested menus.

<ComponentPreview styleName="base-nova" name="MenubarSubmenu" />

### With Icons

<ComponentPreview styleName="base-nova" name="MenubarIcons" />

## RTL

To enable RTL support in shadcn/ui, see the [RTL configuration guide](/docs/rtl).

<ComponentPreview styleName="base-nova" name="MenubarRtl" direction="rtl" />
