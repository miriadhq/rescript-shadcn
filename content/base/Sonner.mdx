...
<ComponentPreview styleName="base-nova" name="SonnerDemo" />
...
<ComponentPreview styleName="base-nova" name="SonnerTypes" />

### Description

<ComponentPreview styleName="base-nova" name="SonnerDescription" />

### Position

Use the `position` prop to change the position of the toast.

<ComponentPreview styleName="base-nova" name="SonnerPosition" />
