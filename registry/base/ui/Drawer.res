...
let make = (props: props) => {
  ...
  <ContextProvider value={value->Nullable.make}>
    <BaseUi.Drawer.Root
      {...props->rootProps} dataSlot={props.dataSlot->Option.getOr("drawer")} modal swipeDirection
    />
  </ContextProvider>
}
...
module Trigger = {
  ...
  let make = (props: BaseUi.Types.BaseUIComponentProps.t) =>
    <BaseUi.Drawer.Trigger {...props} dataSlot={props.dataSlot->Option.getOr("drawer-trigger")} />
}

module Portal = {
  @react.componentWithProps(BaseUi.Types.BaseUIComponentProps.t)
  let make = (props: BaseUi.Types.BaseUIComponentProps.t) =>
    <BaseUi.Drawer.Portal {...props} dataSlot={props.dataSlot->Option.getOr("drawer-portal")} />
}

module Close = {
  @react.componentWithProps(BaseUi.Types.BaseUIComponentProps.t)
  let make = (props: BaseUi.Types.BaseUIComponentProps.t) =>
    <BaseUi.Drawer.Close {...props} dataSlot={props.dataSlot->Option.getOr("drawer-close")} />
}
...
module Overlay = {
  ...
  let make = (props: BaseUi.Types.BaseUIComponentProps.t) =>
    <BaseUi.Drawer.Backdrop
      {...props}
      dataSlot={props.dataSlot->Option.getOr("drawer-overlay")}
      className={cn(
  ...
  let make = (props: BaseUi.Types.BaseUIComponentProps.t) => {
    ...
    <Portal>
      ...
      >
        <BaseUi.Drawer.Popup
          {...props}
          dataSlot={props.dataSlot->Option.getOr("drawer-popup")}
...
module Title = {
  ...
  let make = (props: BaseUi.Types.BaseUIComponentProps.t) =>
    <BaseUi.Drawer.Title
      {...props}
      dataSlot={props.dataSlot->Option.getOr("drawer-title")}
...
module Description = {
  ...
  let make = (props: BaseUi.Types.BaseUIComponentProps.t) =>
    <BaseUi.Drawer.Description
      {...props}
      dataSlot={props.dataSlot->Option.getOr("drawer-description")}
