...
module Handle = {
  type props = {
    ...ResizablePrimitive.Separator.props,
    withHandle?: bool,
  }

  let toBaseUiProps: props => ResizablePrimitive.Separator.props = %raw(`({withHandle, ...props}) => props`)
  ...
  let make = (props: props) => {
    ...
    <ResizablePrimitive.Separator
      {...props->toBaseUiProps}
      dataSlot={props.dataSlot->Option.getOr("resizable-handle")}
      className={cn(
