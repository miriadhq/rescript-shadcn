  ...
  <div className="flex w-full max-w-sm flex-col gap-8 py-12">
    <Message>
      <Message.Content>
        ...
        <Message.Footer>
          <Button variant=Ghost size=Icon ariaLabel="Copy" title="Copy">
            <Icons.Copy />
          </Button>
          <Button variant=Ghost size=Icon ariaLabel="Like" title="Like">
            <Icons.ThumbsUp />
          </Button>
          <Button variant=Ghost size=Icon ariaLabel="Dislike" title="Dislike">
            <Icons.ThumbsDown />
          </Button>
        </Message.Footer>
      </Message.Content>
    ...
    <Message align=End>
      <Message.Content>
        ...
        <Message.Footer className="gap-2">
          ...
          <Button variant=Ghost size=IconXs ariaLabel="Retry" title="Retry">
            <Icons.RefreshCcw />
          </Button>
        </Message.Footer>
      </Message.Content>
