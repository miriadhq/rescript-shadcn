      ...
      <Card.Footer className="flex items-center justify-center border-t">
        ...
        >
          <Tabs.List className="w-full">
            <Tabs.Trigger value="start"> {"start"->React.string} </Tabs.Trigger>
            <Tabs.Trigger value="end"> {"end"->React.string} </Tabs.Trigger>
            <Tabs.Trigger value="last-anchor"> {"last-anchor"->React.string} </Tabs.Trigger>
          </Tabs.List>
        </Tabs>
      </Card.Footer>
    </Card>
