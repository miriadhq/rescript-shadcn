...
let buttonGroupVariants = (~orientation=ReactAria.Types.Orientation.Horizontal) => {
...
let make = ({?role, ?orientation, ?dataSlot, ?className} as props: ReactAria.Types.DomProps.t) => {
  <div
    {...props}
