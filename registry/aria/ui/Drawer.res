...
module DrawerPrimitive = {
  ...
  module Overlay = {
    @module("vaul") @scope("Drawer")
    external make: React.component<ReactAria.Types.DomProps.t> = "Overlay"
  }

  module Content = {
    @module("vaul") @scope("Drawer")
    external make: React.component<ReactAria.Types.BaseUIComponentProps.t> = "Content"
  }

  module Title = {
    @module("vaul") @scope("Drawer")
    external make: React.component<ReactAria.Types.DomProps.t> = "Title"
  }

  module Description = {
    @module("vaul") @scope("Drawer")
    external make: React.component<ReactAria.Types.DomProps.t> = "Description"
  }
}
...
module Content = {
  ...
  let make = (props: ReactAria.Types.BaseUIComponentProps.t) =>
    <Portal>
      ...
      >
        <div
          className="cn-drawer-swipe-handle cn-drawer-handle group-data-[vaul-drawer-direction=bottom]/drawer-content:block"
        />
...
module Footer = {
  ...
  let make = (~className=?, ~children=?, ~id=?, ~style=?, ~onClick=?, ~onKeyDown=?) =>
    <div
      ...
      className={cn("cn-drawer-footer-base cn-drawer-footer mt-auto flex flex-col", className)}
    />
}
