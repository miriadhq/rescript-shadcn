...
let make = ({}: Demo.Props.t) =>
  <div className="grid w-full max-w-sm grid-cols-2 gap-4">
    <ContextMenu>
      ...
      <ContextMenu.Content side=ReactAria.Types.Side.Top>
        <ContextMenu.Group>
    ...
    <ContextMenu>
      ...
      <ContextMenu.Content side=ReactAria.Types.Side.Right>
        <ContextMenu.Group>
          <ContextMenu.Item> {"Back"->React.string} </ContextMenu.Item>
          <ContextMenu.Item> {"Forward"->React.string} </ContextMenu.Item>
          <ContextMenu.Item> {"Reload"->React.string} </ContextMenu.Item>
    ...
    <ContextMenu>
      ...
      <ContextMenu.Content side=ReactAria.Types.Side.Bottom>
        <ContextMenu.Group>
          <ContextMenu.Item> {"Back"->React.string} </ContextMenu.Item>
          <ContextMenu.Item> {"Forward"->React.string} </ContextMenu.Item>
          <ContextMenu.Item> {"Reload"->React.string} </ContextMenu.Item>
    ...
    <ContextMenu>
      ...
      <ContextMenu.Content side=ReactAria.Types.Side.Left>
        <ContextMenu.Group>
          <ContextMenu.Item> {"Back"->React.string} </ContextMenu.Item>
          <ContextMenu.Item> {"Forward"->React.string} </ContextMenu.Item>
          <ContextMenu.Item> {"Reload"->React.string} </ContextMenu.Item>
