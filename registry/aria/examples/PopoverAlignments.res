...
let make = ({}: Demo.Props.t) => {
  <div className="flex gap-6">
    <Popover.Trigger>
      ...
      <Popover placement=ReactAria.Common.BottomStart className="w-40">
        {"Aligned to start"->React.string}
      </Popover>
    </Popover.Trigger>
    <Popover.Trigger>
      <Button variant=Outline size=Sm> {"Center"->React.string} </Button>
      <Popover placement=ReactAria.Common.Bottom className="w-40">
        {"Aligned to center"->React.string}
      </Popover>
    </Popover.Trigger>
    <Popover.Trigger>
      <Button variant=Outline size=Sm> {"End"->React.string} </Button>
      <Popover placement=ReactAria.Common.BottomEnd className="w-40">
