let northAmerica: array<ReactAria.Select.Item.t<null<string>>> = [
...
let europeAfrica: array<ReactAria.Select.Item.t<null<string>>> = [
...
let asia: array<ReactAria.Select.Item.t<null<string>>> = [
...
let australiaPacific: array<ReactAria.Select.Item.t<null<string>>> = [
...
let southAmerica: array<ReactAria.Select.Item.t<null<string>>> = [
