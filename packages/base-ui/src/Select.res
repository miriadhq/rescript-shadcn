...
module ItemText = {
  @module("@base-ui/react/select") @scope("Select")
  external make: React.component<Types.props<'value, 'checked>> = "ItemText"
}
...
module ScrollDownArrow = {
  @module("@base-ui/react/select") @scope("Select")
  external make: React.component<Types.props<'value, 'checked>> = "ScrollDownArrow"
}

module ScrollUpArrow = {
  @module("@base-ui/react/select") @scope("Select")
  external make: React.component<Types.props<'value, 'checked>> = "ScrollUpArrow"
}
