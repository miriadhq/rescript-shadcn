...
The modules mirror the React Aria Components 1.21.1 API and provide typed props for the primitives used by the React Aria shadcn registry in this repository. The package contains declarations only: component adapters and shadcn-compatible prop conversions live in `registry/aria/ui`.
