...
const tsxModules: Record<string, ModuleLoader> = {
  ...(import.meta.glob("../../../shadcn-ui/apps/v4/examples/base/*.tsx") as Record<
    string,
    ModuleLoader
  >),
  ...(import.meta.glob("../../../shadcn-ui/apps/v4/examples/base/ui/*.tsx") as Record<
    ...
    ModuleLoader
  >),
  ...(import.meta.glob("../../../shadcn-ui/apps/v4/examples/base/ui-rtl/*.tsx") as Record<
    string,
    ModuleLoader
  >),
}
...
function getExpectedRescriptPath(component: string) {
  if (component.startsWith("ui-rtl/")) {
    return `registry/base/ui-rtl/Rtl${toPascalCase(component.replace(/^ui-rtl\//, ""))}.res`
  }

  if (component.startsWith("ui/")) {
    return `registry/base/ui/${toPascalCase(component.replace(/^ui\//, ""))}.res`
  }

  return `registry/base/examples/${toPascalCase(component)}.res`
}
